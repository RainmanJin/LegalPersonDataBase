    ...
    var tt = {
        addTooltips: function(pie) {
            ...
            tooltips.selectAll("." + pie.cssPrefix + "tooltip")
                ...
                .style("font-size", function(d) { return pie.options.tooltips.styles.fontSize+"px"; })
        ...
        moveTooltip: function(pie) {
            if(tt.currentTooltip && tt.currentTooltip.indexOf('.')>0)return;
        ...
        hideTooltip: function(pie, index) {
            if((index && index.indexOf('.'))>0 || (tt.currentTooltip && tt.currentTooltip.indexOf('.'))>0)return;
            d3.select("#" + pie.cssPrefix + "tooltip" + index)
