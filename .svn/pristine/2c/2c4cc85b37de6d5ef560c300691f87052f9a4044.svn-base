...
public class CardUtil {
	 ...
	 * @return
	 */
	public static boolean isCardNo(String idNo) {
		try {
			if ("".equals(IDCardValidate(idNo))) {
				return true;
			}
		} catch (Exception e) {
		}
	...
	public static void main(String[] args) throws Exception {
		...
		System.out.println(getHide("姓名: 陈健; 证件名称: ; 证件号码: 330106196212170413; 性别: 男性; 职务: 董事☉☉☈☈姓名: 董丹青; 证件名称: ; 证件号码: 330921197104290049; 性别: 女性; 职务: 监事☉☉☈☈姓名: 耿晖; 证件名称: ; 证件号码: 340302197004180424; 性别: 女性; 职务: 监事☉☉☈☈姓名: 蒋忆; 证件名称: ; 证件号码: 330106620416042; 性别: 女性; 职务: 董事☉☉☈☈姓名: 史烈; 证件名称: ; 证件号码: 330106196412250418; 性别: 男性; 职务: 董事长☉☉☈☈姓名: 张玮兰; 证件名称: ; 证件号码: 330104196711211328; 性别: 女性; 职务: 监事☉☉☈☈"));
