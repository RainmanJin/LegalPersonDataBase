...
/*---------------------------------------------------------------------------------------------------------------------*/
    ...
    function _getJbxxList(pageNum) {
        var ShareholderName = $.trim($('#ShareholderName').val());
        var assetL = $.trim($('#assetL').val());
        var assetH = $.trim($('#assetH').val());
        var LegalPersonName = $.trim($('#LegalPersonName').val());
        var LegalPersonRepresentName = $.trim($('#LegalPersonRepresentName').val());
        
       http.httpRequest({
            url:  window.__FRK__.root_url + "data/search/assetsearch.json",
            data: {ShareholderName: ShareholderName,
            	   assetL:assetL,
            	   assetH:assetH,
            	   LegalPersonName:LegalPersonName,
            	   LegalPersonRepresentName:LegalPersonRepresentName,
            	   pageNum: pageNum, 
            	   pageSize: pageSize},
