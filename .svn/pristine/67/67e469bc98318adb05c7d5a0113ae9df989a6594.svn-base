...
public class CaCyCyxxValidController extends BaseController {
    ...
    public List<CaCyCyxxValidDto> get(@RequestParam(name = "tyxydm", required = false) final String tyxydm,
        ...
        return BeanUtils.copyList(CaCyCyxxValidDto.class, caCyCyxxValids);
    }
}