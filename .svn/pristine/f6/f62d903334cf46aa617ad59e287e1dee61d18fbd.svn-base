 ...
 * @date 2017年05月10日
 */
public interface IBasicSearchService extends BaseService {
	PageInfo<BasicInfoDto> doGetDefinedPage(Map<String, Object> map, int pageNum, int pageSize) throws Exception;
}