...
<div class="wrap2 clearfix">
    ...
    <div class="wrap-l bg-blue mr10">
        ...
        <!-- 读入读出情况 -->
        <div id="main3" style="width:100%; height:310px; margin-bottom: 20px"></div>
    </div>
    <div class="wrap-c mr10">
        <div class="bg-blue clearfix mb10">
            ...
            <div class="l">
                ...
                <div class="fl">
                    <!-- 企业类型总体分布 -->
                    <div id="main4" style="width:160px; height:170px; margin-right:30px"></div>
                </div>
                <div class="fl">
                    <!-- 当月新增企业类型分布 -->
                    <div id="main5" style="width:160px; height:170px; margin-right: 10px"></div>
                </div>
            </div>
            <div class="r">
                <!-- 每周新增法人数量 -->
                <div id="main6" style="width:170px; height:220px;"></div>
            </div>
        </div>
        <div class="bg-blue clearfix mb10">
            <h3 class="title"><i class="handle-task-num-icon"></i>处理任务条数统计</h3>
            <!-- 处理任务条数统计 -->
            <div id="main7" class="fl" style="width:320px; height:190px; margin-right:10px"></div>
            <!-- 累计处理条数 -->
    ...
    <div class="wrap-r">
        <div class="bg-blue mb10">
            ...
            <div class="task-progress-chart">
                <div class="next-task">
                    ...
                    <div>预计待启动时间：<span class="next-task-time">24</span>分钟后</div>
                </div>
        ...
        <div class="bg-blue">
            ...
            <div class="task-progress-gather-chart">
                ...
                <!-- 当前处理任务集合 -->
                <div id="main8" style="width:400px; height:180px; margin-right:40px"></div>
            </div>
        </div>
    </div>
</div>
...
<script>
    ...
    function dailyTaskNumber() {
        chart({
            el: "main1",
            url: "http://localhost:8082/data/dtprocesslog/viewdaydbclearcount.json"
        });
    }
    ...
    function companyType() {
        chart({
            el: "main4",
            url: "http://localhost:8082/data/dtprocesslog/legalpersoncount.json"
        });
    }
    ...
    function handleTaskNumber() {
        chart({
            el: "main7",
            url: "http://localhost:8082/data/dtprocesslog/taskprocesscount.json"
        });
    }
    function curTaskgather() {
        chart({
            el: "main8",
            url: "http://localhost:8082/data/dtprocesslog/currentprocesstask.json"
        });
    }
    ...
    function legalPersonNumber() {
        httpRequest({
            url: "/js/lib/echarts/data44.json",
    ...
    function handleNumeral() {
        httpRequest({
            ...
            success: function (data) {
                ...
                rightnum.text(data.data.num2 + "条, " + rightpre + "%");
                errornum.text(data.data.num1 - data.data.num2 + "条, " + errorpre + "%");
    ...
    function qualityComparison() {
        httpRequest({
            url: "http://localhost:8082/data/dtprocesslog/tasktimecount.json",
            success: function (data) {
    ...
    function handleTask() {
        httpRequest({
            ...
            success: function (data) {
                ...
                $('.next-task-time').text(data.data.dtRwjdxx.rwYxrq/60);
                ...
                $('.processed-num').text(data.data.dtRwjdxx.rwXh == null ? 0 : data.data.rwXh);
                $('.processed-time').text(data.data.dtRwjdxx.rwRwjhs == null ? 0 : data.data.rwRwjhs/60);
