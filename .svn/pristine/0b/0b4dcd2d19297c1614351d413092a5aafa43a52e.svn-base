...
/**
 * 描述:  ca_cx_bgxx_valid 对应的实体类.<br>
 * WARNING：不是表中字段的属性必须加@Transient注解
 *
 * @author framework generator
 * @date 2017年07月05日
 */
@Table(name = "frk.ca_cx_bgxx_valid")
public class CaCxBgxxValid implements Serializable {
   ...
   * @param bgxxbs
   */
  public void setBgxxbs(String bgxxbs) {
    this.bgxxbs = bgxxbs;
  }
