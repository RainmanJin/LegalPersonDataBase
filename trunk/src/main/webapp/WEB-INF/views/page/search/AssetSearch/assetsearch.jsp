					...
					<div class="col-6">
						...
						<div class="col-6">
							<div class="ipt-box col-12">
								<input type="text" name="frmc" class="ipt-txt" placeholder="请输入法人名称(支持模糊查询)">
							</div>
						</div>
					</div>
					<div class="col-6">
						<label class="col-3 item-name text-right">注册资本(万元)：</label>
						<div class="col-5">
							<div class="ipt-box col-575">
								<input type="text" name="assetL" id="assetL" class="ipt-txt" id="assetL">
							</div>
							<span class="col-05 item-line">-</span>
							<div class="ipt-box col-575">
								<input type="text" name="assetH" id="assetH" class="ipt-txt clx" id="assetH">
							</div>
						</div>
					</div>
		...
		<form id="search_form2" class="form-box mb5">
			<div class="form-list pdr8">
				<div class="form-item clearfix">
					...
					<div class="col-6">
						<label class="col-3 item-name text-right">认缴出资额(万元)：</label>
						<div class="col-6">
							<div class="ipt-box col-5">
								<input type="text" name="SoldL" class="ipt-txt" id="SoldL">
							</div>
							<span class="col-05 item-line">-</span>
							<div class="ipt-box col-575">
								<input type="text" name="SoldH" class="ipt-txt clx" id="SoldH">
							</div>
						</div>
					</div>
			...
			<div class="form-list pdr8">
				<div class="form-item clearfix">
					...
					<div class="col-4">
						...
						<div class="col-6">
							<div class="ipt-box col-12">
								<input type="text" class="ipt-txt" name="RegisteNo" value="" placeholder="请输入登记号">
							</div>
						</div>
					</div>
					<div class="col-4">
