 ...
 */
@Table(name="frk.cg_qt_ssxx_valid")
public class CgQtSsxxValid  implements java.io.Serializable{
	...
	public void setGpdm(java.lang.String value) {
		this.gpdm = value;
	}

	public java.lang.String getGpdm() {
		return this.gpdm;
	}

	public void setSjrq(java.util.Date value) {
		this.sjrq = value;
	}

	public java.util.Date getSjrq() {
		return this.sjrq;
	}
