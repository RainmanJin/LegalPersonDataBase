 ...
 */
@Table(name="frk.ch_ccjc_jdcc_valid")
public class ChCcjcJdccValid  implements java.io.Serializable{
	...
	//
	private java.lang.String bccdw;
	//
	private java.lang.String ccchxmmc;
	//
	private java.util.Date jybgrq;
	//
	...
	public void setBccdw(java.lang.String value) {
		this.bccdw = value;
	}

	public java.lang.String getBccdw() {
		return this.bccdw;
	}

	public void setCcchxmmc(java.lang.String value) {
		this.ccchxmmc = value;
	}

	public java.lang.String getCcchxmmc() {
		return this.ccchxmmc;
	}

	public void setJybgrq(java.util.Date value) {
		this.jybgrq = value;
	}

	public java.util.Date getJybgrq() {
		return this.jybgrq;
	}
