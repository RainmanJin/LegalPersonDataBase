...
import com.icinfo.frk.api.dto.CaDjJbxxDto;
 ...
 * @date 2017年06月27日
 */
@RestController("apiCaDjJbxxController")
@RequestMapping("/api/cadjjbxx")
public class CaDjJbxxController extends BaseController {
    ...
    public List<CaDjJbxxDto> get(@RequestParam(name = "tyxydm", required = false) final String tyxydm,
     ...
     *
     * @param tyxydm 统一社会信用代码
     * @param frdwmc 法人单位名称 支持模糊查询
     * @param zzjgdm 组织机构代码
     * @return 法人校核结果
     * @throws Exception 异常
     */
    @RequestMapping(value = "/frcheck", method = {RequestMethod.GET, RequestMethod.POST}, produces = "application/json;charset=UTF-8")
    public List<FrCheckDto> frCheck(@RequestParam(name = "tyxydm", required = false) final String tyxydm,
                                    @RequestParam(name = "frdwmc", required = false) final String frdwmc,
                                    @RequestParam(name = "zzjgdm", required = false) final String zzjgdm) throws Exception {
