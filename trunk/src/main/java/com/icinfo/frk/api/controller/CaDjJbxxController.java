 ...
 * @date 2017年06月27日
 */
@Controller("apiCaDjJbxxController")
...
public class CaDjJbxxController extends BaseController {
    ...
    public ApiResponse get(@RequestParam(name = "tyxydm", required = false) final String tyxydm,
        ...
        if (StringUtils.isBlank(tyxydm) && StringUtils.isBlank(zzjgdm)) {
        ...
        return new ApiResponse(caDjJbxxList);
    }
    ...
    @ResponseBody
    public ApiResponse getPage(@RequestParam(name = "frmc", required = false) String frmc,
        ...
        map.put("frmcLike", frmc);
        map.put("tyxydm", tyxydm);
        map.put("ywfwLike", ywfw);
        List<CaDjJbxx> list = caDjJbxxService.getPage(map, pageNum, pageSize);
